...
get_filename_component(_filename "/home/zya/hector_ws/src/hectorquad/srv/coordinate.srv" NAME_WE)
add_custom_target(_hectorquad_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hectorquad" "/home/zya/hector_ws/src/hectorquad/srv/coordinate.srv" ""
)
...
_generate_srv_cpp(hectorquad
  "/home/zya/hector_ws/src/hectorquad/srv/coordinate.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/hectorquad)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/hectorquad\")")
  # install generated code
  install(
