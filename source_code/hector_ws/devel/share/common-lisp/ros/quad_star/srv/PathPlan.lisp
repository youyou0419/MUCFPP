...
(cl:defmethod cl:initialize-instance :after ((m <PathPlan-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PathPlan-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name quad_star-srv:<PathPlan-request> is deprecated: use quad_star-srv:PathPlan-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <PathPlan-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PathPlan-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name quad_star-srv:<PathPlan-response> is deprecated: use quad_star-srv:PathPlan-response instead.")))
...
(cl:defmethod path-val ((m <PathPlan-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader quad_star-srv:path-val is deprecated.  Use quad_star-srv:path instead.")
  (path m))
